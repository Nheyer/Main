...
def paths():
    ...
    return [inputs,outputfilenm,qk,memopts,str(qual_flag),splkey,genes_list]
...
def main():
    ...
    for loopfile in input_list:
        ...
        os.system('bwa mem '+io_list[3]+' ref.fasta '+loopfile+' > tobekilledfoo_quick_working_sequence.sam')
        os.system('samtools view -Sbq'+io_list[4]+' tobekilledfoo_quick_working_sequence.sam > tobekilledfoo_working_sequence.bam')
